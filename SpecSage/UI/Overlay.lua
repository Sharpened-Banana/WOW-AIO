...
local function CreateOverlayFrame()
    ...
    title:SetText("SpecSage |cff888888(drag to move)|r")
    frame.title = title
...
function UI:UpdateVisibility()
    ...
    -- An explicit /sage overlay hide always wins; the combat filter only
    -- applies when the player has not hidden the overlay by hand.
