...
ns.GuideStore:RegisterSpec("PALADIN", 65, {
  ...
  consumables = {
    ...
    { slot = "Weapon Oil", items = { 243734, 243736, 237371, 237369 }, text = "Thalassian Phoenix Oil - the current tier's weapon oil (+16 Critical Strike and Haste for 2 hours, from Enchanting); Oil of Dawn instead if you'd rather your heals proc a small absorb on their target; Refulgent Whetstone (bladed) or Refulgent Weightstone (blunt) gives +15 Attack Power instead, from Blacksmithing - the two are close, so take whichever is cheaper." },
    { slot = "Weapon Enchant", items = { 244029, 244031, 243997 }, text = "Acuity of the Ren'dorei procs +67 primary stat for 15s; Arcane Mastery procs +124 Mastery instead. The primary-stat proc is the usual default; take the secondary one if your stat weights put Mastery well clear of the rest. Worldsoul Cradle (heals proc a 12.5k barrier on the target) is the healer-flavoured alternative." },
    ...
    { slot = "Gems", items = { 240969, 240896, 240900 }, text = "One Telluric Eversong Diamond (+23 primary stat, +1% mana per unique gem colour) - it's unique-equipped. Then Flawless Masterful Amethyst (+17 Mastery) in every other socket, or Flawless Quick Amethyst (+16 Mastery, +7 Haste) to spread a second colour if your diamond counts colours." },
...
ns.GuideStore:RegisterSpec("PALADIN", 66, {
  ...
  consumables = {
    { slot = "Flask", items = { 241325, 241323, 241321 }, text = "Flask of the Blood Knights for Haste, this spec's top secondary; Flask of the Magisters if your gear already leans hard into Haste and Mastery is the stat you're short on. Flask of Thalassian Resistance (Versatility) is the survivability pick for progression." },
    ...
    { slot = "Gems", items = { 240971, 240888, 240892 }, text = "One Stoic Eversong Diamond (+23 primary stat, +13 armor) - it's unique-equipped. Then Flawless Quick Peridot (+17 Haste) in every other socket, or Flawless Masterful Peridot (+16 Haste, +7 Mastery) to spread a second colour if your diamond counts colours." },
    { slot = "Augment Rune", items = { 259085, 246492, 224572 }, text = "Void-Touched Augment Rune (+25 primary stat for 1 hour; it does not persist through death) for progression pulls and high keys. Soulgorged Augment Rune (+6, persists through death) or Crystallized Augment Rune (+6) are the cheap fallbacks the rest of the time." },
  },
  gear = {
