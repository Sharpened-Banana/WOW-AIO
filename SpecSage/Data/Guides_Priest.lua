...
ns.GuideStore:RegisterSpec("PRIEST", 256, {
  ...
  rotation = {
    { title = "Priorities", steps = {
        { text = "Keep Atonement up on the group before damage lands — apply it through Power Word: Shield or Power Word: Radiance rather than reacting after the fact" },
        { spellID = 194509, text = "Power Word: Radiance to spread Atonement to the group before damage lands" },
        { spellID = 17, text = "Power Word: Shield on the target about to take a hit — mitigation and an Atonement application at once" },
        { spellID = 47540, text = "Penance, thrown at the enemy most of the time — its damage feeds Atonement healing across the raid; aim it at an ally instead only for a single-target healing emergency" },
        { spellID = 8092, text = "Mind Blast on cooldown for more Atonement-feeding damage" },
        { spellID = 585, text = "Smite to maintain Atonement healing with efficient mana use" },
        { spellID = 589, text = "Shadow Word: Pain maintained on your damage target for passive Atonement healing" },
        { spellID = 214621, text = "Schism or a similar damage cooldown to spike Atonement healing" },
        { spellID = 186263, text = "Shadow Mend for a single-target healing emergency when the raid-wide Atonement loop isn't keeping up" },
        { text = "Voidweaver: Void Shield applies Atonement to 3 allies in one cast — use it as a fast group-application tool alongside Power Word: Shield" },
    }},
    { title = "Cooldown Usage", steps = {
        { spellID = 246287, text = "Evangelism to extend your active Atonements — it's on a 4-minute cooldown, so plan the ramp toward a big damage phase rather than firing it on reflex" },
        { spellID = 47536, text = "Rapture right before a damage phase — it strengthens Power Word: Shield and applies Atonement to everyone you shield" },
        ...
        { spellID = 34433, text = "Shadowfiend (or Voidwraith, for Voidweaver) for mana return and extra Atonement-feeding damage" },
  ...
  cooldowns = {
    ...
    { spellID = 246287, text = "Evangelism — extends all active Atonements by several seconds; a 4-minute cooldown, plan it around a sustained damage phase" },
  ...
  consumables = {
    ...
    { slot = "Weapon Enchant", items = { 244029, 243973, 243997 }, text = "Acuity of the Ren'dorei procs +67 primary stat for 15s; Berserker's Rage procs +124 Haste instead. The primary-stat proc is the usual default; take the secondary one if your stat weights put Haste well clear of the rest. Worldsoul Cradle (heals proc a 12.5k barrier on the target) is the healer-flavoured alternative." },
    ...
    { slot = "Gems", items = { 240969, 240888, 240892 }, text = "One Telluric Eversong Diamond (+23 primary stat, +1% mana per unique gem colour) - it's unique-equipped. Then Flawless Quick Peridot (+17 Haste) in every other socket, or Flawless Masterful Peridot (+16 Haste, +7 Mastery) to spread a second colour if your diamond counts colours." },
  ...
  tips = {
    ...
    "Point Penance at an enemy by default; only aim it at an ally when you need a direct single-target heal right now.",
    "Don't push extra damage casts beyond what your healing rotation naturally provides — Discipline's damage is a byproduct of healing, not a separate goal to maximize.",
  },
})
...
ns.GuideStore:RegisterSpec("PRIEST", 257, {
  ...
  rotation = {
    { title = "Priorities", steps = {
        { text = "This is a reactive throughput loop rather than a strict cast order — lean on your short cooldowns often and let incoming damage tell you which one to press" },
        { spellID = 33076, text = "Prayer of Mending kept bouncing — recast it before it runs out of jumps" },
        ...
        { spellID = 204883, text = "Circle of Healing as another AoE option for a stacked group" },
        { spellID = 2060, text = "Heal when you have time to cast it, Flash Heal when you don't" },
        ...
        { text = "React to Surge of Light procs by firing off the free instant Flash Heal it grants rather than letting it fall off" },
        { text = "Weave damage spells (Smite/Holy Fire) when healing demand is low to reduce Holy Word cooldowns — if talented into Serendipity, Renew and Prayer of Healing chip away at those cooldowns too, so don't skip them for pure damage-weaving" },
    }},
    { title = "Cooldown Usage", steps = {
        ...
        { spellID = 265202, text = "Holy Word: Salvation, if talented, for a huge raid cooldown that also seeds Renew and Prayer of Mending across the group" },
        { spellID = 47788, text = "Guardian Spirit as an emergency save on a critical target — your best tool for a tank about to die to a big hit" },
  ...
  cooldowns = {
    ...
    { spellID = 265202, text = "Holy Word: Salvation (if talented) — huge raid-wide cooldown that also seeds Renew and Prayer of Mending" },
  ...
  consumables = {
    { slot = "Flask", items = { 241321, 241327 }, text = "Flask of Thalassian Resistance for Versatility, this spec's top secondary; Flask of the Shattered Sun if your gear already leans hard into Versatility and Critical Strike is the stat you're short on." },
    { slot = "Food", items = { 275265, 275266, 255846, 275259, 242756 }, text = "Raid feasts: Loa's Gathering or Feast of Knowledge (Stamina plus your highest secondary, new in 12.1), or Harandar Celebration / Silvermoon Parade (Stamina plus 50 primary stat) - the two families sim within a fraction of a percent of each other, so eat whichever is down. Solo and Mythic+: Hearty Venom-Spiced Cutlets or Hearty Puffer Plate (highest secondary) or Hearty Void-Kissed Fish Rolls (Versatility); Hearty food persists through death." },
    { slot = "Potion", items = { 241301, 241295, 241289, 271884 }, text = "Lightfused Mana Potion is the safe mana return; Potion of Devoured Dreams gives more over 10s but leaves you defenceless while it channels, so only when nothing is targeting you. Potion of Recklessness (+1585 highest secondary for 30s) for a throughput window instead. Always carry Concentrated Silvermoon Health Potions." },
    { slot = "Weapon Oil", items = { 243734, 243736 }, text = "Thalassian Phoenix Oil - the current tier's weapon oil (+16 Critical Strike and Haste for 2 hours, from Enchanting); Oil of Dawn instead if you'd rather your heals proc a small absorb on their target." },
    { slot = "Weapon Enchant", items = { 244029, 244001, 243997 }, text = "Acuity of the Ren'dorei procs +67 primary stat for 15s; Worldsoul Tenacity procs +124 Versatility instead. The primary-stat proc is the usual default; take the secondary one if your stat weights put Versatility well clear of the rest. Worldsoul Cradle (heals proc a 12.5k barrier on the target) is the healer-flavoured alternative." },
    { slot = "Ring Enchants", items = { 244017, 243987 }, text = "Silvermoon's Tenacity (+29 Versatility) on both rings; Nature's Fury (+29 Critical Strike) if you're topping up your second stat instead. Use the greater tier - the lesser one is +24." },
    { slot = "Chest Enchant", items = { 243977, 244003 }, text = "Mark of the Worldsoul (+50 primary stat); Mark of the Magister (+40 Intellect, +5% mana) if mana is what runs out." },
    { slot = "Leg Enchant", items = { 240133, 240155 }, text = "Sunfire Silk Spellthread (+41 Intellect, +115 Stamina); Arcanoweave Spellthread (+41 Intellect, +4% mana) if you'd rather have the mana than the health." },
    { slot = "Helm, Shoulders and Boots", items = { 243979, 243963, 244009, 244021, 243983 }, text = "Helm: Blessing of Speed (+13). Shoulders: Akil'zon's Swiftness (+65 Speed) or Silvermoon's Mending (+166 Leech). Boots: Farstrider's Hunt (+11 Speed, +232 Stamina) or Shaladrassil's Roots (+28 Leech, +232 Stamina). Speed is the throughput-neutral default; swap to Leech for a progression fight you keep dying on." },
    { slot = "Gems", items = { 240969, 240912, 240914 }, text = "One Telluric Eversong Diamond (+23 primary stat, +1% mana per unique gem colour) - it's unique-equipped. Then Flawless Versatile Lapis (+17 Versatility) in every other socket, or Flawless Deadly Lapis (+16 Versatility, +7 Critical Strike) to spread a second colour if your diamond counts colours." },
    { slot = "Augment Rune", items = { 259085, 246492, 224572 }, text = "Void-Touched Augment Rune (+25 primary stat for 1 hour; it does not persist through death) for progression pulls and high keys. Soulgorged Augment Rune (+6, persists through death) or Crystallized Augment Rune (+6) are the cheap fallbacks the rest of the time." },
  },
  gear = {
  ...
  tips = {
    ...
    "Don't hoard Prayer of Mending or your Holy Words waiting for a bigger moment — casting them regularly is both more healing and more mana-efficient than saving them.",
...
ns.GuideStore:RegisterSpec("PRIEST", 258, {
  ...
  rotation = {
    { title = "Single Target", steps = {
        ...
        { spellID = 15407, text = "Mind Flay as your primary Insanity-neutral filler — cast Mind Flay: Insanity instead whenever a Surge of Insanity proc is up, it's the stronger version of the same filler" },
    ...
    { title = "AoE", steps = {
        ...
        { spellID = 199484, text = "Psychic Link (if talented) to spread a quarter of your direct damage to every other Vampiric Touch target in range" },
        { spellID = 120517, text = "Halo on cooldown for extra AoE damage, if it's in your build" },
        { text = "Spend Void Volley casts during Voidform for burst during add waves" },
        { text = "Keep DoTs rolling on as many targets as your Insanity budget allows — realistically that ceiling is around 12 targets before Insanity can't keep pace" },
    }},
    { title = "Opener Notes", steps = {
        { text = "A tight opener looks like: pre-cast Vampiric Touch and Mind Blast just before the pull, open with Tentacle Slam to seed Shadow Word: Pain and Vampiric Touch, Void Volley, enter Voidform and pop trinkets/potion, Power Infusion, another Void Volley, Shadow Word: Madness, then Void Torrent" },
  ...
  cooldowns = {
    { text = "Voidform — your burst-window cooldown, use on cooldown; sync it with Power Infusion and your on-use trinkets/potion, since that combined 2-minute cycle is Shadow's core burst window" },
  ...
  tips = {
    ...
    "Insanity is a builder/spender resource outside Voidform too — don't let it sit capped, spend it toward Shadow Word: Madness.",
