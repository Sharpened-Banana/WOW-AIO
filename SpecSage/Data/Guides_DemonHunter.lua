...
ns.GuideStore:RegisterSpec("DEMONHUNTER", 577, {
  ...
  overview = {
    ...
    "The core resource is Fury, generated by Demon's Bite/Fel Rush-style abilities and spent on Chaos Strike (or Annihilate while transformed) for damage and Blade Dance/Death Sweep for cleave. Inertia (Momentum's replacement) rewards staying mobile: Fel Rush or Vengeful Retreat sets up a trigger that your next action consumes for a damage buff.",
    "Bring Havoc when you want extremely high mobility, strong burst windows via Eye Beam and Metamorphosis, and good AoE through Glaive Tempest, in exchange for a rotation that rewards careful Fury management.",
  },
  statPriority = {
    { stat = "primary" },
    { stat = "crit" },
  ...
  rotation = {
    { title = "Opener", steps = {
        { text = "Vengeful Retreat into Fel Rush (triggers Inertia) to open with mobility and Fury" },
        { spellID = 198013, text = "Eye Beam early to line up with cooldowns and start consuming your Inertia trigger" },
        { spellID = 191427, text = "Metamorphosis once Fury and cooldowns are ready for the main burst window" },
    ...
    { title = "AoE", steps = {
        ...
        { text = "Glaive Tempest (talent-dependent) for extra AoE burst" },
  ...
  cooldowns = {
    { spellID = 191427, text = "Metamorphosis — major burst cooldown with extra mobility, use aligned with Eye Beam and raid cooldowns" },
...
ns.GuideStore:RegisterSpec("DEMONHUNTER", 581, {
  ...
  rotation = {
    { title = "Single Target", steps = {
        { text = "Fracture to generate Fury and Soul Fragments" },
        { spellID = 228477, text = "Soul Cleave to spend Fury for damage and strong self-healing" },
        { text = "Immolation Aura on cooldown for passive AoE damage and Fury generation" },
        { spellID = 212084, text = "Fel Devastation for burst damage and healing when available" },
        { spellID = 204596, text = "Sigil of Flame to debuff the target and generate extra Fury" },
        { text = "Opener Notes: Vengeance splits along the Aldrachi Reaver and Annihilator hero trees — both keep this Fracture-into-Soul-Cleave loop, Sigil of Flame or Sigil of Spite make a good precombat opener depending on your build" },
    }},
    { title = "AoE", steps = {
        ...
        { spellID = 247454, text = "Spirit Bomb (talent) to detonate Soul Fragments for AoE damage, in place of Soul Cleave" },
    ...
    { title = "Mitigation", steps = {
        { spellID = 203720, text = "Demon Spikes to increase armor, use proactively and keep charges from capping" },
        ...
        { spellID = 203720, text = "Don't let Demon Spikes charges cap — use them before a hit lands, not just when low" },
    }},
  },
  cooldowns = {
    ...
    { spellID = 203720, text = "Demon Spikes — frequent mitigation charge, use proactively rather than reactively" },
    { spellID = 212084, text = "Fel Devastation — damage + self-healing cooldown, use when a healing boost is valuable" },
  },
  consumables = {
