...
ns.GuideStore:RegisterSpec("MONK", 268, {
  ...
  consumables = {
    ...
    { slot = "Weapon Enchant", items = { 244029, 244001, 243999 }, text = "Acuity of the Ren'dorei procs +67 primary stat for 15s; Worldsoul Tenacity procs +124 Versatility instead. The primary-stat proc is the usual default; take the secondary one if your stat weights put Versatility well clear of the rest. Worldsoul Aegis (a 14k barrier that erupts when it breaks) is the defensive alternative." },
    ...
    { slot = "Gems", items = { 240971, 240912, 240914 }, text = "One Stoic Eversong Diamond (+23 primary stat, +13 armor) - it's unique-equipped. Then Flawless Versatile Lapis (+17 Versatility) in every other socket, or Flawless Deadly Lapis (+16 Versatility, +7 Critical Strike) to spread a second colour if your diamond counts colours." },
...
ns.GuideStore:RegisterSpec("MONK", 270, {
  ...
  consumables = {
    { slot = "Flask", items = { 241325, 241327 }, text = "Flask of the Blood Knights for Haste, this spec's top secondary; Flask of the Shattered Sun if your gear already leans hard into Haste and Critical Strike is the stat you're short on." },
    ...
    { slot = "Gems", items = { 240969, 240888, 240890 }, text = "One Telluric Eversong Diamond (+23 primary stat, +1% mana per unique gem colour) - it's unique-equipped. Then Flawless Quick Peridot (+17 Haste) in every other socket, or Flawless Deadly Peridot (+16 Haste, +7 Critical Strike) to spread a second colour if your diamond counts colours." },
    { slot = "Augment Rune", items = { 259085, 246492, 224572 }, text = "Void-Touched Augment Rune (+25 primary stat for 1 hour; it does not persist through death) for progression pulls and high keys. Soulgorged Augment Rune (+6, persists through death) or Crystallized Augment Rune (+6) are the cheap fallbacks the rest of the time." },
  },
  gear = {
...
ns.GuideStore:RegisterSpec("MONK", 269, {
  ...
  consumables = {
    ...
    { slot = "Helm, Shoulders and Boots", items = { 243979, 243963, 244009, 244021, 243983 }, text = "Helm: Blessing of Speed (+13). Shoulders: Akil'zon's Swiftness (+65 Speed) or Silvermoon's Mending (+166 Leech). Boots: Farstrider's Hunt (+11 Speed, +232 Stamina) or Shaladrassil's Roots (+28 Leech, +232 Stamina). Speed is the throughput-neutral default; swap to Leech for a progression fight you keep dying on." },
    { slot = "Gems", items = { 240967, 240888, 240890 }, text = "One Powerful Eversong Diamond (+23 primary stat and crit effectiveness per unique gem colour you socket) - it's unique-equipped. Then Flawless Quick Peridot (+17 Haste) in every other socket, or Flawless Deadly Peridot (+16 Haste, +7 Critical Strike) to spread a second colour if your diamond counts colours." },
    { slot = "Augment Rune", items = { 259085, 246492, 224572 }, text = "Void-Touched Augment Rune (+25 primary stat for 1 hour; it does not persist through death) for progression pulls and high keys. Soulgorged Augment Rune (+6, persists through death) or Crystallized Augment Rune (+6) are the cheap fallbacks the rest of the time." },
  },
  gear = {
