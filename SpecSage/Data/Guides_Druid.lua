...
ns.GuideStore:RegisterSpec("DRUID", 104, {
  ...
  consumables = {
    { slot = "Flask", items = { 241325, 241321, 241321 }, text = "Flask of the Blood Knights for Haste, this spec's top secondary; Flask of Thalassian Resistance if your gear already leans hard into Haste and Versatility is the stat you're short on. Flask of Thalassian Resistance (Versatility) is the survivability pick for progression." },
    ...
    { slot = "Ring Enchants", items = { 244015, 244017 }, text = "Silvermoon's Alacrity (+29 Haste) on both rings; Silvermoon's Tenacity (+29 Versatility) if you're topping up your second stat instead. Use the greater tier - the lesser one is +24." },
    { slot = "Chest Enchant", items = { 243977, 243975 }, text = "Mark of the Worldsoul (+50 primary stat); Mark of the Rootwarden (+40 Agility, +15 Speed) trades a little stat for movement." },
    ...
    { slot = "Gems", items = { 240971, 240888, 240894 }, text = "One Stoic Eversong Diamond (+23 primary stat, +13 armor) - it's unique-equipped. Then Flawless Quick Peridot (+17 Haste) in every other socket, or Flawless Versatile Peridot (+16 Haste, +7 Versatility) to spread a second colour if your diamond counts colours." },
    { slot = "Augment Rune", items = { 259085, 246492, 224572 }, text = "Void-Touched Augment Rune (+25 primary stat for 1 hour; it does not persist through death) for progression pulls and high keys. Soulgorged Augment Rune (+6, persists through death) or Crystallized Augment Rune (+6) are the cheap fallbacks the rest of the time." },
  },
  gear = {
