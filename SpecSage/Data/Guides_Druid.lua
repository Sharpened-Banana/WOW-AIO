...
ns.GuideStore:RegisterSpec("DRUID", 102, {
  ...
  rotation = {
    ...
    { title = "Single Target", steps = {
        ...
        { text = "Cast Wrath or Starfire to prime the next Eclipse, then press Eclipse itself once it's off cooldown to enter it" },
